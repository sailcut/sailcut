 ...
 *
 * $Id: panel.cpp,v 1.1 2006/02/01 19:41:14 jeremy_laine Exp $
 *
...
void CPanel::addHems( const real &lw, const real &tw, const real &rw, const real &bw)
{
    ...
    if ( v5.norm() > .1)
    {
        ...
        l2 = CSubSpace(cutLeft.point[0],v1.matrix(),GEOCPP_FROM_BASE);
    ...
    if ( v6.norm() > .1)
    {
        ...
        l2 = CSubSpace(cutLeft.point[npl-1],v2.matrix(),GEOCPP_FROM_BASE);
